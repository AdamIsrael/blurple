...
# Thanks to bsherman, for https://github.com/bsherman/bos/blob/main/desktop-1password.sh, which
# I've ripped off to build 1password into the image rather than layering it.
